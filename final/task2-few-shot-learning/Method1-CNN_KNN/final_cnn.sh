...
python3 prediction.py --version 38 --shot 5 --data $2 --output $3 --load ./classifier_189_classifier.pkl --seed 29
python3 prediction.py --version 38 --shot 10 --data $2 --output $3 --load ./classifier_189_classifier.pkl --seed 29
